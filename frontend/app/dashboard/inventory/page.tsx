                                        ...
                                        <tr key={item.id} className="hover:bg-indigo-50/10 transition-colors group">
                                            <td className="pl-8 pr-6 py-6">
                                                <div className="flex items-center gap-4">
                                                    <div className="w-14 h-14 rounded-2xl bg-gray-50 flex items-center justify-center text-gray-400 shrink-0 border border-gray-100 shadow-sm overflow-hidden group-hover:border-indigo-200 transition-colors">
                                                        <Package className="w-6 h-6 group-hover:text-indigo-500 transition-colors" />
                                                    </div>
                                                    <div className="min-w-0">
                                                        <p className="text-base font-black text-gray-900 truncate pr-4">{item.name || 'Unnamed Product'}</p>
                                                        <div className="flex items-center gap-3 mt-1.5 ">
                                                            {item.shopify_variant_id && (
                                                                <span className="flex items-center gap-1 text-[10px] font-black text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md uppercase border border-blue-100">
                                                                    <ShoppingBag className="w-3 h-3" /> Shopify
                                                                </span>
                                                            )}
                                                            {item.etsy_variant_id && (
                                                                <span className="flex items-center gap-1 text-[10px] font-black text-orange-600 bg-orange-50 px-2 py-0.5 rounded-md uppercase border border-orange-100">
                                            ...
                                            <td className="px-6 py-6">
                                                <span className="text-sm font-black text-gray-500 tracking-tight bg-gray-50 px-3 py-1.5 rounded-xl border border-gray-100">{item.sku || 'NO-SKU'}</span>
                                            </td>
                                            ...
                                            <td className="px-6 py-6 text-center">
                                                <span className="text-lg font-black text-gray-900">{item.available_stock}</span>
                                            </td>
                                            <td className="pl-6 pr-8 py-6 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    <button
                                                        ...
                                                        className="px-4 py-2.5 bg-white border border-gray-200 text-gray-700 font-bold text-xs rounded-xl shadow-sm hover:border-indigo-500 hover:text-indigo-600 transition-all flex items-center gap-2 active:scale-95"
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-2.5 text-gray-400 hover:text-indigo-600 hover:bg-white border border-transparent hover:border-indigo-100 rounded-xl transition-all"
                                                        title="Force re-sync"
                                                    >
